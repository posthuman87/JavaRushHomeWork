...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catGrPa = new Cat(grandPaName);
        Cat catGrMa = new Cat(grandMaName);
        Cat catFather = new Cat(fatherName, catGrPa, null);
        Cat catMother = new Cat(motherName, null, catGrMa);
