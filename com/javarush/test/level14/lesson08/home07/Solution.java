...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        for (Apartament x : apartaments){
            if (x instanceof Apt1Room) ((Apt1Room) x).clean1Room(); else
            if (x instanceof Apt2Room) ((Apt2Room) x).clean2Rooms(); else
            if (x instanceof Apt3Room) ((Apt3Room) x).clean3Rooms();//написать тут вашу реализацию пунктов 1-4
        }
    }
