...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (loadedObject.equals(classWithStatic)) System.out.println("true"); else System.out.println("false");//check here that classWithStatic object equals to loadedObject object - проверьте тут, что classWithStatic и loadedObject равны
