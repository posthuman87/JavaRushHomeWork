...
public class Solution {
    ...
    public  static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (string1 == null) System.out.println("null"); else string1.print();
            if (string2 == null) System.out.println("null"); else string2.print();
        ...
        public void load(InputStream inputStream) throws Exception {
            BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
                ...
                java.lang.String s1 = reader.readLine();
                if (s1.equals("null")) string1 = null; else {
                    countStrings = Integer.parseInt(s1.split("#")[1])-1;
                    string1 = new String();
                }
            s1 = reader.readLine();
            if (s1.equals("null")) string2 = null; else {
                countStrings = Integer.parseInt(s1.split("#")[1])-1;
                string2 = new String();
            }
            countStrings = count;
