...
1.2. Вторичная сортировка по дате без учета часов, минут, секунд (сверху самые новые), потом по прибыли от положительных к
 отрицательным
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                else
                {
                ...
                else
                    {
                        ...
                        if (compareChanges != 0) return compareChanges;
                        else
                            return 0;
                    }
                }
