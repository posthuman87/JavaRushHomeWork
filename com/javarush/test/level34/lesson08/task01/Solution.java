...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getFilledList() {
            ArrayList<PhantomReference<Monkey>> referenceList = new ArrayList<PhantomReference<Monkey>>();
            for (int i = 0; i < 200; i++)
            {
                referenceList.add(new PhantomReference<Monkey>(new Monkey(), getQueue()));
            }
